# 个股分析标准模版 (V5.5.16 控股结构安全与现金流归因版)
...
| **决策** | [第七章 决策与持仓](template/07-决策流程与持仓管理.md) | 买卖标准、仓位管理、VHSI监测、弹性差策略、高低切换记录、投资复盘模板、**分账户隔离、风格匹配度** | 10-15分钟 |
...
*当前版本: V5.5.16 | 重构完成: 2026-04-30 | 原始完整版已归档至 `归档版本/analysis-template_V5.5.14_重构前完整版.md`*
